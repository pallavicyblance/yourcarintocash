...
$(document).ready(function(){
    ...
    // $('#conditon_close').click(function(){
    //     $('#auction-condition').empty();
    //     $('#vehicle-detail').empty();
    // })

    // $('#exteriormodalLabel').click(function(){
    //     $('#exterior_report').empty();
    // })
    ...
    // $('#mechnical_close').click(function(){
    //     $('#mechnical_report').empty();
    // })

    // $('#driveability_close').click(function(){
    //     $('#driveability_report').empty();
    // })
    ...
    // $('#tries_close').click(function(){
    //     $('#tires_report').empty();
    // })

    // $('#interior_close').click(function(){
    //     $('#interior_report').empty();
    // })
            ...
            success: function(response) {
                ...
                if (data.length == 0) {
                    ...
                    data.forEach(auction => {
                        ...
                        str += '<td><div class="vehicle-img"><a href="'+ auction[42]+'" rel="prettyPhoto[gallery]"><img src="'+ auction[42]+'" style="width:67px;height:49px" ></a></td>'
                        
                        str += '<td>' + auction[23] + ' VIN:'+ auction[11] + '</td>';
            ...
            success: function(response) {
                ...
                if (won_auction.length == 0) {
                    ...
                    won_auction.forEach(auction => {
                        ...
                        str1 += '<td><div class="vehicle-img"><a href="'+ auction[42]+'" rel="prettyPhoto[gallery]"><img src="'+ auction[42]+'" style="width:67px;height:49px" ></a></td>'
                        
                        str1 += '<td>' + auction[23] + ' VIN:'+ auction[11] + '</td>';
                ...
                if (lost_auction.length == 0) {
                    ...
                    lost_auction.forEach(auction => {
                        ...
                        str2 += '<td><div class="vehicle-img"><a href="'+ auction[42]+'" rel="prettyPhoto[gallery]"><img src="'+ auction[42]+'" style="width:67px;height:49px" ></a></td>'
                        
                        str2 += '<td>' + auction[23] + ' VIN:'+ auction[11] + '</td>';
    ...
    function upcomingMissedAuction(e){
        ...
        $('.auction-show, .auction-upcoming-show, .auction-missed-show, .auction-lost-show, .auction-won-show, .auction-live-show').hide();
    ...
    function upcomingauction(){
        ...
        $.ajax({
            url:  WS_PATH + '/upcoming-live-auction-data/',
            type: 'GET',
            success: function(response) {
                var data = response;                    
                var str = '';
    ...
    function missedauction(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (data.length == 0) {
                    str += '<tr>';
                        str += '<td colspan="8" align="center">No data found</td>';
                    str += '</tr>';
                }else{
                    data.forEach(auction => {
                        str += '<tr>';
    ...
    function liveauctions(){
        $('.auction-live-show').show();
        $.ajax({
            url:  WS_PATH + '/live-auctions/',
            type: 'GET',
            success: function(response) {
                ...
                var str = '';
                    if (data.length == 0) {
                        ...
                        data.forEach(auction => {
                            ...
                            str += '<td>' + auction[23] + '<a href="'+ auction[42]+'" rel="prettyPhoto[gallery]"><img src="'+ auction[42]+'" style="width:67px;height:49px" class="img-preview"></a></td>';
                    ...
                    $('#dataConditionallive tbody').html(str);
...
function condition_popup_open(id){
    ...
    // $('.loader').show();
    $.ajax({
        url: WS_PATH + '/get-live-auction-condition/',
        data:  {auction_id:id},
        type: 'POST',
        success: function (response) {
            if (response.length != null) {
                ...
                if (conditionresponse != null) {
                    ...
                    var undercarriage_surface_rust = JSON.parse(conditionresponse[98]);
                    var undercarriage_heavy_rust = JSON.parse(conditionresponse[99]);
                    var undercarriage_heavy_rot = JSON.parse(conditionresponse[100]);
                    ...
                    if (minor_body_damage['selected'] == true){
                        var minorBodyDamageHtml = '<div class="col-lg-6 bg_yellow"><div><div> <b>' + minor_body_damage['questionTitle'] + ': </b>'+ minor_body_damage['answer'][0]['value']+'</div> </div>';
                    ...
                    if (surface_rust['selected'] == true){
                        ...
                        $('#exterior_report').append('<div class="col-lg-6"><div> <b>' + surface_rust['questionTitle'] + ': </b> ' + surface_rust['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
    
                    }else{
                        $('#exterior_report').append('<div class="col-lg-6"><div> <b>' + surface_rust['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }
                    ...
                    if (heavy_rust['selected'] == true){
                        ...
                        $('#exterior_report').append('<div class="col-lg-6"><div> <b>' + heavy_rust['questionTitle'] + ': </b> ' + heavy_rust['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
                    }else{
                        $('#exterior_report').append('<div class="col-lg-6"><div> <b>' + heavy_rust['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }
                    ...
                    if (penetratingRust['selected'] == true){
                        ...
                        $('#exterior_report').append('<div class="col-lg-6"><div> <b>' + penetratingRust['questionTitle'] + ': </b> ' + penetratingRust['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
                    }else{
                        $('#exterior_report').append('<div class="col-lg-6"><div> <b>' + penetratingRust['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }
                    ...
                    if (unbodyDamage['selected'] == true){
                        ...
                        $('#frame_report').empty().append('<div class="col-lg-6"><div> <b>' + unbodyDamage['questionTitle'] + ': </b> ' + unbodyDamage['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
                    }else{
                        $('#frame_report').empty().append('<div class="col-lg-6"><div> <b>' + unbodyDamage['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }

                    if (undercarriage_surface_rust['selected'] == true){
                        var undercarriage_surface_rust_html = '<div class="col-lg-6 bg_yellow"><div> <b>' + undercarriage_surface_rust['questionTitle'] + ': </b>'+ undercarriage_surface_rust['answer'][0]['value']+ '</div></div>';
    
                        $('#frame_report').append('<div class="col-lg-6"><div> <b>' + undercarriage_surface_rust['questionTitle'] + ': </b> ' + undercarriage_surface_rust['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
                    }else{
                        $('#frame_report').append('<div class="col-lg-6"><div> <b>' + undercarriage_surface_rust['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }

                    if (undercarriage_heavy_rust['selected'] == true){
                        var undercarriage_heavy_rust_html = '<div class="col-lg-6 bg_orange"><div> <b>' + undercarriage_heavy_rust['questionTitle'] + ': </b>'+ undercarriage_heavy_rust['answer'][0]['value']+ '</div></div>';
    
                        $('#frame_report').append('<div class="col-lg-6"><div> <b>' + undercarriage_heavy_rust['questionTitle'] + ': </b> ' + undercarriage_heavy_rust['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
                    }else{
                        $('#frame_report').append('<div class="col-lg-6"><div> <b>' + undercarriage_heavy_rust['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }

                    if (undercarriage_heavy_rot['selected'] == true){
                        var undercarriage_heavy_rot_html = '<div class="col-lg-6 "><div> <b>' + undercarriage_heavy_rot['questionTitle'] + ': </b>'+ undercarriage_heavy_rot['answer'][0]['value']+ '</div></div>';
    
                        $('#frame_report').append('<div class="col-lg-6"><div> <b>' + undercarriage_heavy_rot['questionTitle'] + ': </b> ' + undercarriage_heavy_rot['answer'][0]['value'] + '</div> <div class="text-right text-success">Yes</div> </div>'); 
                    }else{
                        $('#frame_report').append('<div class="col-lg-6"><div> <b>' + undercarriage_heavy_rot['questionTitle'] + '</b> </div> <div class="text-right text-danger">  No </div></div>');
                    }
                ...
                .append(undercarriage_heavy_rust_html)
                ...
                .append(undercarriage_surface_rust_html)
                ...
                .append(undercarriage_heavy_rot_html)
