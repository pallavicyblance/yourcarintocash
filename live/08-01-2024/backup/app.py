...
def conditionfilter():
    ...
    if not session.get('admin_logged_in'):
        ...
        return render_template('condition-filter.html',modelresult=modelresult,data=data,states=states, sessionid = sessionid)
...
def conditionalReportDetail(id):
    ...
    #new code value added end here country
    return render_template('conditional-fetch.html',data=data,stateComma=stateComma)
